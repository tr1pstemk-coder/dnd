  ...
  return (
    <>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* ── Wealth: 2 ряда по 2 монеты */}
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Богатство</Text>
          {/* Ряд 1: Платина + Золото */}
          <View style={styles.wealthRow}>
            <View style={styles.coinCol}>
              <View style={[styles.coinIcon, { backgroundColor: Colors.purple + '22' }]}>
                <Text style={[styles.coinLabel, { color: Colors.purple }]}>ПМ</Text>
              </View>
              <Text style={styles.coinName}>Платина</Text>
              <NumberInput
                value={char.wealth.pp}
                onChange={v => upd({ wealth: { ...char.wealth, pp: v } })}
                min={0}
                compact
              />
            </View>
            <View style={styles.coinCol}>
              <View style={[styles.coinIcon, { backgroundColor: Colors.gold + '22' }]}>
                <Text style={[styles.coinLabel, { color: Colors.gold }]}>ЗМ</Text>
              </View>
              <Text style={styles.coinName}>Золото</Text>
              <NumberInput
                value={char.wealth.gp}
                onChange={v => upd({ wealth: { ...char.wealth, gp: v } })}
                min={0}
                compact
              />
            </View>
          ...
          <View style={styles.wealthRow}>
            <View style={styles.coinCol}>
              <View style={[styles.coinIcon, { backgroundColor: Colors.textSecondary + '22' }]}>
                <Text style={[styles.coinLabel, { color: Colors.textSecondary }]}>СМ</Text>
              </View>
              <Text style={styles.coinName}>Серебро</Text>
              <NumberInput
                value={char.wealth.sp}
                onChange={v => upd({ wealth: { ...char.wealth, sp: v } })}
                min={0}
                compact
              />
            </View>
            <View style={styles.coinCol}>
              <View style={[styles.coinIcon, { backgroundColor: '#a1620722' }]}>
                <Text style={[styles.coinLabel, { color: '#a16207' }]}>ММ</Text>
              </View>
              <Text style={styles.coinName}>Медь</Text>
              <NumberInput
                value={char.wealth.cp}
                onChange={v => upd({ wealth: { ...char.wealth, cp: v } })}
                min={0}
                compact
              />
            </View>
...
const styles = StyleSheet.create({
  ...
  // Wealth
  wealthRow: { flexDirection: 'row', gap: 12 },
  ...
  coinName: { color: Colors.textMuted, fontSize: Fonts.xs, marginBottom: 2 },
  // Items
  itemCard: {
    backgroundColor: Colors.surface,
